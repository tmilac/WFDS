...
!  REAL(EB), POINTER, DIMENSION(:,:,:,:) :: DMPVDT_FM_VEG
   ...
   REAL(EB), POINTER, DIMENSION(:,:) :: HEAD_WIDTH,ROS_HEAD,ROS_FLANK,ROS_BACKU,WIND_EXP,FLANKFIRE_LIFETIME
   ...
   REAL(FB), POINTER, DIMENSION(:,:) :: CRUZ_CROWN_PROB_OUT,FLI_OUT,MAG_SR_OUT,PHI_OUT,ROS_X_OUT,ROS_Y_OUT,TOA
