...
!  REAL(EB), POINTER, DIMENSION(:,:,:,:) :: DMPVDT_FM_VEG
   ...
   REAL(EB), POINTER, DIMENSION(:,:) :: HEAD_WIDTH,ROS_HEAD,ROS_HEAD_FM10,ROS_HEAD_CROWN,ROS_FLANK,ROS_BACKU,WIND_EXP,FLANKFIRE_LIFETIME
   REAL(EB), POINTER, DIMENSION(:,:) :: PHI_LS,PHI0_LS,PHI1_LS,PHI_TEMP_LS
   REAL(EB), POINTER, DIMENSION(:,:) :: FLUX_LS,FLUX0_LS,FLUX1_LS,SR_X_LS,SR_Y_LS,SR_X_FM10_LS,SR_Y_FM10_LS
   ...
   REAL(EB), POINTER, DIMENSION(:,:) :: CFB_SR_LS,PHI_S_FM10,PHI_S_X_FM10,PHI_S_Y_FM10,PHI_W_X_FM10,PHI_W_Y_FM10, &
                                        PHI_W_FM10,UMF_FM10,RAC_THRESHOLD_LS,ROS_SURF_INI_LS
   REAL(FB), POINTER, DIMENSION(:,:) :: CFB_OUT,CRUZ_CROWN_PROB_OUT,FLI_OUT,HRRPUA_IN,HRRPUA_OUT,MAG_SR_OUT,PHI_OUT,ROS_X_OUT,ROS_Y_OUT,TOA
   ...
   REAL(EB) :: DT_COEF,DT_LS,DYN_SR_MAX,SUM_T_SLCF_LS,SUMTIME_LS,TIME_LS
...
CHARACTER(80), POINTER, DIMENSION(:) :: FN_SLCF_LS
INTEGER, POINTER, DIMENSION(:)       :: LU_SLCF_LS
REAL(EB), POINTER :: DT_COEF,DT_LS,DYN_SR_MAX,SUM_T_SLCF_LS,SUMTIME_LS,TIME_LS
