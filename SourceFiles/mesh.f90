...
!  REAL(EB), POINTER, DIMENSION(:,:,:,:) :: DMPVDT_FM_VEG
   ...
   REAL(EB), POINTER, DIMENSION(:,:) :: HEAD_WIDTH,ROS_HEAD,ROS_HEAD_FM10,ROS_HEAD_CROWN,ROS_HEAD_SA,ROS_FLANK,ROS_BACKU,WIND_EXP,FLANKFIRE_LIFETIME
   ...
   REAL(FB), POINTER, DIMENSION(:,:) :: CFB_OUT,CRUZ_CROWN_PROB_OUT,FLI_OUT,HRRPUA_IN,HRRPUA_OUT,MAG_SR_OUT,PHI_OUT,ROS_X_OUT,ROS_Y_OUT, &
                                        ROS10_X_OUT,ROS10_Y_OUT,RSA_X_OUT,RSA_Y_OUT,TOA
