...
!  REAL(EB), POINTER, DIMENSION(:,:,:,:) :: DMPVDT_FM_VEG
   ...
   REAL(EB), POINTER, DIMENSION(:,:) :: CFB_SR_LS,PHI_S_FM10,PHI_S_X_FM10,PHI_S_Y_FM10,PHI_W_X_FM10,PHI_W_Y_FM10, &
                                        PHI_W_FM10,UMF_FM10,RAC_THRESHOLD_LS,ROS_ACTIVE_MAG,ROS_SURF_INI_LS
   REAL(FB), POINTER, DIMENSION(:,:) :: CFB_OUT,CRUZ_CROWN_PROB_OUT,FLI_OUT,HRRPUA_IN,HRRPUA_OUT,MAG_SR_OUT,PHI_OUT,RINI_OUT,ROS_ACTIVE_MAG_OUT, &
...
ROS_ACTIVE_MAG   => M%ROS_ACTIVE_MAG
...
PHI_OUT       => M%PHI_OUT
RINI_OUT      => M%RINI_OUT
ROS_ACTIVE_MAG_OUT => M%ROS_ACTIVE_MAG_OUT
