...
!-- Arrays for ouputs
  ...
  ALLOCATE(M%ROS_ACTIVE_MAG_OUT(0:IBAR,0:JBAR)) ; CALL ChkMemErr('INIT','ROS_ACTIVE_MAG_OUT',IZERO) ; M%ROS_ACTIVE_MAG_OUT = 0.0
...
!-- Arrays for implementing Scott and Reinhardt crown fire model
  ...
  ALLOCATE(M%ROS_ACTIVE_MAG(0:IBP1,0:JBP1))  ; CALL ChkMemErr('INIT','ROS_ACTIVE_MAG',IZERO)  ; M%ROS_ACTIVE_MAG= 0.0_EB
