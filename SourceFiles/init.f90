...
!-- Arrays for ouputs
  ...
  ALLOCATE(M%HRRPUA_OUT(0:IBAR,0:JBAR)) ; CALL ChkMemErr('INIT','HRRPUA_OUT',IZERO) ; M%HRRPUA_OUT= 1.0
...
!-- Arrays with names of output files and LU 
  ALLOCATE(M%FN_SLCF_LS(6)) ; CALL ChkMemErr('INIT','FN_SLCF_LS',IZERO)
  ALLOCATE(M%LU_SLCF_LS(6)) ; CALL ChkMemErr('INIT','LU_SLCF_LS',IZERO)
