...
TYPE SURFACE_TYPE
   ...
   LOGICAL ::  VEG_LSET_CROWN_VEG,VEG_LSET_HEADWIDTH_DEPENDENCE,VEG_LSET_BURNER,VEG_LSET_SPREAD,VEG_LSET_ELLIPSE, &
               VEG_LSET_TAN2
   REAL(EB) :: VEG_LSET_BURNER_TIME_OFF,VEG_LSET_BURNER_TIME_ON,VEG_LSET_IGNITE_TIME,VEG_LSET_ROS_HEAD,VEG_LSET_ROTH_ZEROWINDSLOPE_ROS, &
               ...
               VEG_LSET_WAF_SHELTERED,VEG_LSET_CROWNFIRE_ANGLE
