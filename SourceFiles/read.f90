...
IF (FN_INPUT(1:1)==' ') THEN
   ...
   IF (MYID==0) THEN
      ...
      WRITE(LU_ERR,'(/A)')  "WFDS, September 19, 2015; based on subversion 9977 of FDS"
...
REAL(EB) :: VEGETATION_CDRAG,VEGETATION_CHAR_FRACTION,VEGETATION_ELEMENT_DENSITY,VEGETATION_HEIGHT, &
            ...
            VEGETATION_SVRATIO,VEGETATION_H_PYR,FIRELINE_MLR_MAX,VEGETATION_GROUND_TEMP, &
            VEG_LSET_ROS_HEAD,VEG_LSET_ROS_FLANK,VEG_LSET_ROS_BACK, &
            VEG_LSET_WIND_EXP,VEG_LSET_BETA,VEG_LSET_HT,VEG_LSET_SIGMA,VEG_LSET_ELLIPSE_HEAD,VEG_LSET_PHIDEPTH, &
            VEG_LSET_HEAT_OF_COMBUSTION
LOGICAL :: VEG_LSET_HEADWIDTH_DEPENDENCE,VEGETATION,VEGETATION_NO_BURN,VEGETATION_LINEAR_DEGRAD, &
           VEGETATION_ARRHENIUS_DEGRAD,VEGETATION_CHAR_OXIDATION,VEGETATION_HCONV_CYLRE,VEGETATION_HCONV_CYLLAM, &
...
NAMELIST /SURF/ ADIABATIC,BACKING,BOUNDARY_CONDITION_FILENAME,BURN_AWAY,CELL_SIZE_FACTOR,COLOR,CONVECTION_LENGTH_SCALE, &
                ...
                TMP_BACK,TMP_FRONT,TMP_INNER,TRANSPARENCY,VEGETATION,VEGETATION_ARRHENIUS_DEGRAD, &
                VEGETATION_CHAR_OXIDATION,VEGETATION_HCONV_CYLRE,VEGETATION_HCONV_CYLLAM,VEGETATION_CDRAG,&
                VEGETATION_CHAR_FRACTION,VEGETATION_ELEMENT_DENSITY,VEGETATION_GROUND_TEMP,VEGETATION_HEIGHT,&
                VEGETATION_INITIAL_TEMP,VEGETATION_LAYERS,VEGETATION_LINEAR_DEGRAD,VEGETATION_LOAD,VEGETATION_H_PYR, &
                ...
                VEL,VEL_T,VOLUME_FLUX,WIDTH,XYZ,Z0,VEG_LSET_SIGMA,VEG_LSET_HT,&
                VEG_LSET_BETA,VEG_LSET_ELLIPSE,VEG_LSET_TAN2,VEG_LSET_ELLIPSE_HEAD,VEG_LSET_HEADWIDTH_DEPENDENCE, &
                VEG_LSET_PHIDEPTH,VEG_LSET_HEAT_OF_COMBUSTION
...
!  SF%VEG_LSET_IGNITE = .FALSE.
!  IF(SF%VEG_LSET_IGNITE_T > -1._EB) SF%VEG_LSET_IGNITE= .TRUE.
...
!  SF%VEG_DEHYDRATION_RATE_MAX = SRF_VEG_DEHYDRATION_RATE_MAX
   ...
   SF%VEG_CHAR_OXIDATION   = VEGETATION_CHAR_OXIDATION
   IF(VEGETATION_ARRHENIUS_DEGRAD) SF%VEG_LINEAR_DEGRAD = .FALSE.
   SF%VEG_H_PYR = VEGETATION_H_PYR*1000._EB !convert to J/kg
   SF%VEG_HCONV_CYLRE  = VEGETATION_HCONV_CYLRE
   SF%VEG_HCONV_CYLLAM = VEGETATION_HCONV_CYLLAM
...
VEGETATION_CHAR_OXIDATION    = .FALSE.
VEGETATION_H_PYR             = 418._EB !kJ/kg from Morvan
VEGETATION_HCONV_CYLRE       = .FALSE. !cylindrical Re dependent convection heat transfer
VEGETATION_HCONV_CYLLAM      = .TRUE. !cylindrical laminar convection heat transfer (Holman)

VEG_LSET_ROS_HEAD            = 0.5_EB
VEG_LSET_ELLIPSE_HEAD        = 0.1_EB
VEG_LSET_ROS_FLANK           = 0.01_EB
VEG_LSET_ROS_BACK            = 0.01_EB
...
VEG_LSET_SIGMA               = 10000_EB
VEG_LSET_QCON                = 0.0_EB !kW/m^2
VEG_LSET_PHIDEPTH            = 0.0_EB 
