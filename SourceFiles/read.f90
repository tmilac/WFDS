...
!     WRITE(LU_ERR,'(A,A)') "Compile Date: ",TRIM(COMPILE_DATE)
      WRITE(LU_ERR,'(/A)')  "WFDS, July 26, 2017; based on subversion 9977 (2012) of FDS"
...
REAL(EB) :: VEG_DRAG_CONSTANT,VEG_ASH_FRACTION,VEG_CHAR_FRACTION,VEG_DENSITY,VEG_HEIGHT, &
            VEGETATION_INITIAL_TEMP,VEG_LOAD,VEG_LSET_BURNER_TIME_OFF,VEG_LSET_BURNER_TIME_ON,VEG_LSET_IGNITE_TIME,VEG_LSET_QCON, &
...
NAMELIST /SURF/ ADIABATIC,BACKING,BOUNDARY_CONDITION_FILENAME,BURN_AWAY,CELL_SIZE_FACTOR,COLOR,CONVECTION_LENGTH_SCALE, &
                ...
                VEG_CHAR_OXIDATION,VEG_DEGRADATION,VEG_HCONV_CYLRE,VEG_HCONV_CYLLAM,VEG_DRAG_CONSTANT,&
                ...
                VEG_LSET_CROWN_FIRE_HEAD_ROS_MODEL,VEG_LSET_WAF_UNSHELTERED,VEG_LSET_WAF_SHELTERED,VEG_LSET_CROWNFIRE_ANGLE, &
                VEG_LSET_HRRPUA_MINIMUM_FRAC
