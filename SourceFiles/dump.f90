...
!              IF (PC%TREE .AND. .NOT. LP%IGNITOR) QP(NPP,NN) = LP%VEG_FUEL_MASS*V_CELL*LP%VEG_VOLFRACTION
            ...
            CASE(441)  ! VEG_DRY_MASS
               QP(NPP,NN) = LP%VEG_FUEL_MASS*V_CELL*LP%VEG_VOLFRACTION
            CASE(442)  ! VEG_MOIST_MASS
               QP(NPP,NN) = LP%VEG_MOIST_MASS*V_CELL*LP%VEG_VOLFRACTION
            CASE(443)  ! VEG_DIVQC
               QP(NPP,NN) = LP%VEG_DIVQC*V_CELL*0.001_EB
            CASE(444)  ! VEG_DIVQR
               QP(NPP,NN) = LP%VEG_DIVQR*V_CELL*0.001_EB
         END SELECT
      ENDDO
   ENDDO LOAD_LOOP
