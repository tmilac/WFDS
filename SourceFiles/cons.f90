...
LOGICAL  :: LSET_IGNITION=.FALSE.,VEG_LEVEL_SET,VEG_LEVEL_SET_COUPLED,VEG_LEVEL_SET_UNCOUPLED
LOGICAL  :: RK2_PREDICTOR_LS,LSET_ELLIPSE,LSET_TAN2
REAL     :: DT_LS_UNCOUPLED,PHI_MIN_LS,PHI_MAX_LS
!REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: ASPECT,FLANKFIRE_LIFETIME,PHI_LS,PHI0_LS,PHI1_LS,PHI_TEMP_LS,FLUX0_LS,FLUX1_LS, &
!                                         SR_X_LS,SR_Y_LS,U_LS,V_LS,BURN_TIME_LS,DZTDX,DZTDY,MAG_ZT,CFB_LS,PHI_WS, &
!                                         PHI_S,PHI_S_X,PHI_S_Y,PHI_W_X,PHI_W_Y,PHI_W,UMF_X,UMF_Y,UMF,THETA_ELPS
